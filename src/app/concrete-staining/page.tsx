...
export default function ConcreteStainingPage() {
  return (
    <>
      <section className="relative overflow-hidden bg-gradient-to-br from-[#1b1238] via-[#0f0a1c] to-black py-24 text-white">
        <div className="absolute inset-0">
          <div className="absolute left-10 top-10 h-64 w-64 rounded-full bg-purple-400/30 blur-3xl" />
        </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {concreteHighlights.map((highlight) => (
                ...
                >
                  ...
                  <p className="mt-2 text-sm text-purple-100/80">{highlight.description}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <Container className="grid gap-12 lg:grid-cols-[1.1fr,1fr]">
          <div className="space-y-5">
            ...
            <ol className="space-y-4 border-l-2 border-purple-400/40 pl-6 text-sm text-slate-200/80">
              <li>
                <strong className="block font-semibold text-white">1. Surface preparation</strong>
                Removal of dirt, oil, and laitance plus optional crack repair for a flawless base.
              </li>
              <li>
                <strong className="block font-semibold text-white">2. Color selection</strong>
                Sample swatches and custom mixing to align with your exterior palette.
              </li>
              <li>
                <strong className="block font-semibold text-white">3. Professional application</strong>
                Even coverage with commercial-grade stains and dyes, tailored to desired depth.
              </li>
              <li>
                <strong className="block font-semibold text-white">4. Protective sealing</strong>
                Clear coats in wet-look gloss or natural matte, plus slip-resistant options.
              </li>
            </ol>
          </div>
          <div className="relative overflow-hidden rounded-3xl border border-white/10 shadow-[0_25px_75px_rgba(0,0,0,0.5)]">
            <Image
