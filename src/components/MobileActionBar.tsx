...
export function MobileActionBar() {
  return (
    <div className="fixed bottom-4 left-1/2 z-40 w-[calc(100%-2rem)] max-w-sm -translate-x-1/2 rounded-full border border-slate-200 bg-white/95 p-2 shadow-[0_14px_35px_rgba(15,23,42,0.18)] backdrop-blur md:hidden">
      <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wide text-slate-700">
        ...
        <Link
          href="/contact"
          className="flex-1 rounded-full border border-purple-500 px-4 py-2 text-center text-purple-600 transition hover:bg-purple-600 hover:text-white"
